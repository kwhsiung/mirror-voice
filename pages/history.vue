  ...
  >
    ...
    >
      ...
      <BaseTrackList
        ...
        :is-playing="appPlayerRefactor.audioIsPlaying"
        :tracks="tracks"
        :page="1"
        :total="total"
...
export default {
  ...
  computed: {
    ...
    currentSound() {
      return _.get(
        this.appPlayerRefactor.audioList,
        this.appPlayerRefactor.audioCurrentIndex,
        {}
      )
    },
    ...
    ...mapState({
      localStorageTrackHistory: state =>
        state.localStorageTrackHistoryRefactor.dict
    }),
    tracks() {
